  ...
  return (
    <footer className="bg-[#2d2d2d] text-white py-20">
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-16">
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">Servicing Greater Sydney</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-brand-teal flex-shrink-0" />
                <a href="tel:1300668253" className="text-gray-300 hover:text-brand-teal transition-colors">
                  1300 NOVALE (1300 668 253)
                </a>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-brand-teal flex-shrink-0" />
                <a href="mailto:info@novale.com.au" className="text-gray-300 hover:text-brand-teal transition-colors">
                  info@novale.com.au
                </a>
              </div>
              <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <nav className="flex flex-col space-y-3">
              ...
              <NavLink to="/about" className="text-gray-300 hover:text-brand-teal transition-colors">
                About Us
              </NavLink>
              <NavLink to="/why-choose-us" className="text-gray-300 hover:text-brand-teal transition-colors">
                Why Choose Us
              </NavLink>
              <NavLink to="/who-is-novale" className="text-gray-300 hover:text-brand-teal transition-colors">
                Who is Novalé
              </NavLink>
              <NavLink to="/team" className="text-gray-300 hover:text-brand-teal transition-colors">
                Our Team
              </NavLink>
              <NavLink to="/projects" className="text-gray-300 hover:text-brand-teal transition-colors">
                Our Projects
              </NavLink>
          ...
          <div>
            ...
            <nav className="flex flex-col space-y-3">
              ...
              <NavLink to="/services/kitchen" className="text-gray-300 hover:text-brand-teal transition-colors">
                Kitchen Renovations
              </NavLink>
              <NavLink to="/services/laundry" className="text-gray-300 hover:text-brand-teal transition-colors">
                Laundry Renovations
              </NavLink>
        ...
        {/* Accreditations Bar */}
        <div className="py-8 mb-12 border-t border-b border-gray-700">
          <div className="flex flex-wrap items-center justify-center gap-8 text-center">
            ...
            <div className="text-gray-300">
              ...
              <p className="text-xs text-gray-400">Master Builders</p>
            </div>
            <div className="text-gray-300">
              <p className="text-sm font-semibold text-white mb-1">HIA Member</p>
              <p className="text-xs text-gray-400">Housing Industry</p>
            </div>
            <div className="text-gray-300">
              <p className="text-sm font-semibold text-white mb-1">Fully Licensed</p>
              <p className="text-xs text-gray-400">NSW Licensed Builder</p>
            </div>
            <div className="text-gray-300">
              <p className="text-sm font-semibold text-white mb-1">10 Year Warranty</p>
              <p className="text-xs text-gray-400">Waterproofing Guarantee</p>
            </div>
          </div>
        </div>
