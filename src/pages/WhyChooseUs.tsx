        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="fade-in">
              <h3 className="text-xl font-serif mb-4">ISO 9001 Certified</h3>
            ...
            <div className="fade-in">
              <h3 className="text-xl font-serif mb-4">22+ Years Experience</h3>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <div className="fade-in">
              <h3 className="text-xl font-serif mb-4">Stress-Free Process</h3>
              <p className="text-muted-foreground leading-relaxed">
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto space-y-20">
          ...
          <div className="max-w-4xl mx-auto text-center fade-in">
            <h2 className="text-2xl font-serif mb-6">Family Values</h2>
            <p className="text-lg leading-relaxed text-muted-foreground">
